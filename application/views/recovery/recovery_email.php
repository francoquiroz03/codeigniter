...
<body>
	<h1>Ingrese Email y Codigo enviado a su correo</h1>
	<div class="login-form">
		...
		<div class="clear"></div>
			...
			if(isset($message))
			{
				if($codigo==2 || $codigo==null)
				{

				echo form_open('recovery_code'); ?>
					<input type="text" value="Email" name="email" id="email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email';}" required>
					<input type="text" value="Codigo" name="codigo" id="codigo" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'codigo';}" required>
					<div class="clear"></div>
